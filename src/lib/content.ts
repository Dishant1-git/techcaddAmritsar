...
export const navItems: NavItem[] = [
  ...
  {
    label: "AI",
    href: "/courses/best-artificial-intelligence-course-in-amritsar",
    sparkle: true,
    mega: "ai",
    children: [
      { label: "Generative AI", href: "/courses/best-generative-ai-course-in-amritsar" },
      { label: "Artificial Intelligence (AI)", href: "/courses/best-artificial-intelligence-course-in-amritsar" },
      { label: "Prompt Engineering", href: "/courses/best-prompt-engineering-course-in-amritsar" },
      { label: "ChatGPT & AI Tools", href: "/courses/best-chatgpt-ai-tools-course-in-amritsar", badge: "Hot" },
      { label: "Agentic AI", href: "/courses/best-agentic-ai-course-in-amritsar", badge: "Hot" },
      { label: "AI-Powered Marketing", href: "/courses/best-ai-powered-marketing-course-in-amritsar", badge: "Hot" },
      { label: "RAG Development", href: "/courses/best-rag-development-course-in-amritsar" },
      { label: "AI-Powered Courses", href: "/courses/best-ai-powered-course-in-amritsar" },
    ],
  },
  {
    label: "Courses",
    ...
    children: [
      ...
      { label: "Generative AI", href: "/courses/best-generative-ai-course-in-amritsar" },
      { label: "IT Foundation Programme", href: "/courses/best-it-course-in-amritsar" },
  ...
  columns: [
    {
      ...
      links: [
        { label: "Python", href: "/courses/best-python-course-in-amritsar" },
        { label: "Java", href: "/courses/best-java-course-in-amritsar" },
        { label: "C & C++", href: "/courses/best-c-cpp-course-in-amritsar" },
        { label: "Kotlin", href: "/courses/best-kotlin-course-in-amritsar" },
        { label: "Web Designing", href: "/courses/best-web-designing-course-in-amritsar" },
        { label: "Web Development", href: "/courses/best-web-development-course-in-amritsar" },
        { label: "MERN Stack", href: "/courses/best-mern-stack-course-in-amritsar" },
        { label: "MEAN Stack", href: "/courses/best-mean-stack-course-in-amritsar" },
        { label: "PHP Full Stack", href: "/courses/best-php-full-stack-course-in-amritsar" },
        { label: "IT Foundation Programme", href: "/courses/best-it-course-in-amritsar" },
      ],
    },
    {
      ...
      links: [
        { label: "Artificial Intelligence", href: "/courses/best-artificial-intelligence-course-in-amritsar" },
        { label: "Machine Learning", href: "/courses/best-machine-learning-course-in-amritsar" },
        { label: "Deep Learning", href: "/courses/best-deep-learning-course-in-amritsar" },
        { label: "Data Science", href: "/courses/best-data-science-course-in-amritsar" },
        { label: "Data Analytics", href: "/courses/best-data-analytics-course-in-amritsar" },
        { label: "Power BI", href: "/courses/best-power-bi-course-in-amritsar" },
        { label: "Tableau", href: "/courses/best-tableau-course-in-amritsar" },
      ],
    },
    {
      index: "03",
      ...
      links: [
        { label: "Digital Marketing", href: "/courses/best-digital-marketing-course-in-amritsar" },
        { label: "Social Media Marketing", href: "/courses/best-social-media-marketing-course-in-amritsar" },
        { label: "Google Ads", href: "/courses/best-google-ads-course-in-amritsar" },
        { label: "SEO", href: "/courses/best-seo-course-in-amritsar" },
        { label: "WordPress", href: "/courses/best-wordpress-course-in-amritsar" },
        { label: "Shopify", href: "/courses/best-shopify-course-in-amritsar" },
      ],
    },
    {
      index: "04",
      ...
      links: [
        { label: "Cybersecurity", href: "/courses/best-cybersecurity-course-in-amritsar" },
        { label: "Ethical Hacking", href: "/courses/best-ethical-hacking-course-in-amritsar" },
        { label: "Cloud Computing", href: "/courses/best-cloud-computing-course-in-amritsar" },
        { label: "Linux", href: "/courses/best-linux-course-in-amritsar" },
      ],
    },
  ],
...
export const aiMenu = {
  ...
  groups: [
    ...
    },
    {
      ...
      links: [
        { label: "Agentic AI", href: "/courses/best-agentic-ai-course-in-amritsar", badge: "Hot" },
        { label: "AI-Powered Marketing", href: "/courses/best-ai-powered-marketing-course-in-amritsar", badge: "Hot" },
        { label: "RAG (Retrieval-Augmented Generation)", href: "/courses/best-rag-development-course-in-amritsar" },
        { label: "Machine Learning", href: "/courses/best-machine-learning-course-in-amritsar" },
      ] as NavChild[],
    },
  ],
  ...
  promo: {
    ...
    cta: { label: "Explore AI", href: "/courses/best-artificial-intelligence-course-in-amritsar" },
  },
};
  ...
  items: [
    {
      ...
      group: "IT Courses",
      body: LOREM_SHORT,
      href: "/courses/best-it-course-in-amritsar",
      count: "18 programmes",
...
export const featured = {
  ...
  cybersecurity: {
    ...
    body: LOREM_SHORT,
    href: "/courses/best-cybersecurity-course-in-amritsar",
    bullets: ["Live pentest labs", "CEH-aligned syllabus", "Lorem ipsum dolor sit"],
  },
  dataScience: {
    title: "Data Science & Analytics",
    body: LOREM_SHORT,
    href: "/courses/best-data-science-course-in-amritsar",
    liveLabel: "Live",
    delta: "+38%",
  ...
  aiml: {
    ...
    badge: "AI",
    body: LOREM_MED,
    href: "/courses/best-machine-learning-course-in-amritsar",
  },
  fullStack: {
    title: "Full-Stack Development",
    body: LOREM_MED,
    href: "/courses/best-mern-stack-course-in-amritsar",
  ...
  digitalMarketing: {
    title: "Digital Marketing",
    body: LOREM_SHORT,
    href: "/courses/best-digital-marketing-course-in-amritsar",
    alerts: [
  ...
  columns: [
    ...
    },
    {
      ...
      links: [
        ...
        { label: "AI", href: "/courses/best-artificial-intelligence-course-in-amritsar" },
